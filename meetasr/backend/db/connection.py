...
def init_db() -> None:
    ...
    import meetasr.backend.db.models  # noqa: F401
    import meetasr.backend.db.models_phase2  # noqa: F401
...
def _ensure_unique_documents() -> None:
    ...
    """
    from meetasr.backend.db.models_phase2 import Document, DocumentDuplicateArchive
